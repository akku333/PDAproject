...
forest_inspection <- read_csv ("C:/Users/neerajkulshrestha/Downloads/PDA_proj/Forest_data/Data.csv")
...
write.csv(forest_inspection1, "d1.csv")
write.csv(tree_points1, "d2.csv")
